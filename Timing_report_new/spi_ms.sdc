...
# Created by write_sdc on Thu Dec 21 17:06:14 2023

###################################################################
set sdc_version 2.0

set_units -time ns -resistance kOhm -capacitance pF -voltage V -current mA
set_load -pin_load 0.0074636 [get_ports {sfr_data_o[7]}]
set_load -pin_load 0.0074636 [get_ports {sfr_data_o[6]}]
set_load -pin_load 0.0074636 [get_ports {sfr_data_o[5]}]
set_load -pin_load 0.0074636 [get_ports {sfr_data_o[4]}]
set_load -pin_load 0.0074636 [get_ports {sfr_data_o[3]}]
set_load -pin_load 0.0074636 [get_ports {sfr_data_o[2]}]
set_load -pin_load 0.0074636 [get_ports {sfr_data_o[1]}]
set_load -pin_load 0.0074636 [get_ports {sfr_data_o[0]}]
set_load -pin_load 0.0074636 [get_ports {spssn_o[7]}]
set_load -pin_load 0.0074636 [get_ports {spssn_o[6]}]
set_load -pin_load 0.0074636 [get_ports {spssn_o[5]}]
set_load -pin_load 0.0074636 [get_ports {spssn_o[4]}]
set_load -pin_load 0.0074636 [get_ports {spssn_o[3]}]
set_load -pin_load 0.0074636 [get_ports {spssn_o[2]}]
set_load -pin_load 0.0074636 [get_ports {spssn_o[1]}]
set_load -pin_load 0.0074636 [get_ports {spssn_o[0]}]
...
set_drive 5.92186  [get_ports clk]
set_drive 5.92186  [get_ports rst_n]
set_drive 5.92186  [get_ports {sfraddr_w[1]}]
set_drive 5.92186  [get_ports {sfraddr_w[0]}]
set_drive 5.92186  [get_ports sfrwe]
set_drive 5.92186  [get_ports {spidata_i[7]}]
set_drive 5.92186  [get_ports {spidata_i[6]}]
set_drive 5.92186  [get_ports {spidata_i[5]}]
set_drive 5.92186  [get_ports {spidata_i[4]}]
set_drive 5.92186  [get_ports {spidata_i[3]}]
set_drive 5.92186  [get_ports {spidata_i[2]}]
set_drive 5.92186  [get_ports {spidata_i[1]}]
set_drive 5.92186  [get_ports {spidata_i[0]}]
set_drive 5.92186  [get_ports {sfraddr_r[2]}]
set_drive 5.92186  [get_ports {sfraddr_r[1]}]
set_drive 5.92186  [get_ports {sfraddr_r[0]}]
set_drive 5.92186  [get_ports {spssn_i[7]}]
set_drive 5.92186  [get_ports {spssn_i[6]}]
set_drive 5.92186  [get_ports {spssn_i[5]}]
set_drive 5.92186  [get_ports {spssn_i[4]}]
set_drive 5.92186  [get_ports {spssn_i[3]}]
set_drive 5.92186  [get_ports {spssn_i[2]}]
set_drive 5.92186  [get_ports {spssn_i[1]}]
set_drive 5.92186  [get_ports {spssn_i[0]}]
set_drive 5.92186  [get_ports mosi]
set_drive 5.92186  [get_ports miso]
set_drive 5.92186  [get_ports sck]
set_drive 5.92186  [get_ports ssn]
